 ...
 */
final class Version20201208123725 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_transformer (id INT NOT NULL, uuid UUID NOT NULL, PRIMARY KEY(id))');
